...
class Bolita(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # Cargar imagen
        self.image = pygame.image.load("/home/leiner/AO/Tasca11/Ex14/bola.png")
...
class Paleta(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        # Cargar imagen
        self.image = pygame.image.load("/home/leiner/AO/Tasca11/Ex14/barra.png")
        # Obtener rectangulo de la imagen
        self.rect = self.image.get_rect()
...
class Ladrillo(pygame.sprite.Sprite):
    def __init__(self, posicion):
        pygame.sprite.Sprite.__init__(self)
        # Cargar imagen
        self.image = pygame.image.load("/home/leiner/AO/Tasca11/Ex14/ladrillo.png")
        # Obtener rectangulo de la imagen
        self.rect = self.image.get_rect()
